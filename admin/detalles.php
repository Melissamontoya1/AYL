...
if (isset($_GET['id_creacion']) ) {
	...
	$comparar= "SELECT r.id_respuestas_e,r.nombre_respuesta,r.estado_respuesta, r.archivo_respuesta,r.id_creacion_fk,r.cod_archivo_e_fk,a.cod_archivo_e, a.nombre_archivo_e,a.archivo_e,a.id_item_estandar_fk,a.tipo_archivo_e
	FROM respuestas_evaluacion r
	INNER JOIN archivos_evaluacion a
	ON r.cod_archivo_e_fk=a.cod_archivo_e
	WHERE  r.estado_respuesta='Completo' AND r.id_creacion_fk='{$id_creacion}' ";
	if ($result = $sqlconnection->query($comparar)) {
		if ($result->num_rows > 0) {
			while($res = $result->fetch_array(MYSQLI_ASSOC)) {
				$item_respuesta=$res['id_item_estandar_fk'];

				$updateItemQuery = "UPDATE evaluacion SET  estado_evaluacion='completo' WHERE id_item_estandar_fk = '{$item_respuesta}' ";
	...
	<div class="content-wrapper">
		...
		<section class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1>Código Evaluación # <?php echo $id_creacion ?></h1>
					</div>
					<div class="col-sm-6">
										...
										<div class="card-body">
											<div class="row no-gutters align-items-center">
												<div class="col mr-2">
													<?php
													$porcentaje1='0';
													$suma1 = "SELECT e.id_evaluacion, e.fecha_evaluacion, e.id_item_estandar_fk, e.justificacion_evaluacion, e.id_creacion_fk, e.estado_evaluacion, sum(e.porcentaje_evaluacion) AS porcentaje, cre.id_creacion, cre.fecha_creacion, cre.id_empresa_fk, cre.id_users_fk,
													i.id_item_estandar, i.indice_item_estandar, i.pregunta_item_estandar, i.valor_item_estandar, i.id_ciclo_fk, i.id_categoria_estandar_fk, i.id_subcategoria_estandar_fk,
													...
													WHERE c.nombre_ciclo='{$nombre_ciclo}' AND e.estado_evaluacion='completo' AND e.id_creacion_fk='{$id_creacion}' AND cre.id_empresa_fk='$id_empresa'
													";
													...
													<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
														...
														<div class="col-auto text-center">
															<input type="text" class="knob" value="<?php echo $porcentaje ?>" data-width="100" data-height="100" data-fgColor="#17D7A0">

															<div class="knob-label"><?php echo $nombre_ciclo ?></div>
												...
												if ($result->num_rows > 0) {
													while($item = $result->fetch_array(MYSQLI_ASSOC)) {
														...
														<tr class="text-center">
															...
															<td>
																<a class="btn btn-success btn-block" href="respuesta.php?id_evaluacion=<?php echo $id_evaluacion ?>&id_item_estandar=<?php echo $id_item_estandar ?>&id_creacion=<?php echo $id_creacion ?> "> Responder </a>
															</td>
														</tr>
