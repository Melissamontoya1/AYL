...
$empresas = "SELECT 
e.id_empresa, e.nombre_empresa, e.direccion_empresa, e.telefono_empresa, e.correo_empresa, e.gerente_empresa, e.cumple_gerente, e.logotipo_empresa, e.tipo_empresa, e.fecha_inicio, e.fecha_fin,e.firma_gerente, u.id, u.identificacion, u.username, u.firstname, u.lastname, u.email, u.password, u.role, u.id_empresa_fk,e.nombre_representante,e.firma_representante,e.cedula_representante
...
$TBS->MergeField('datos.nombre_representante', $nombre_representante);
$TBS->MergeField('datos.cedula_representante', $cedula_representante);
$TBS->VarRef['x'] = $logotipo;
$firma_gerente='../firmas/'.$firma_gerente_empresa;
$TBS->VarRef['f'] = $firma_gerente;
$firma_repre='../firmas/'.$firma_representante;
$TBS->VarRef['m'] = $firma_repre;
