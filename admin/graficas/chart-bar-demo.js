...
var myBarChart = new Chart(ctx, {
  type: 'bar',
  data: {
    labels: ["Agosto", "February", "March", "April", "May", "June"],
    datasets: [{
      label: "Revenue",
      ...
      if ($resultevaluacion = $sqlconnection->query($porcentajeeva)) {
        ...
        if ($resultevaluacion->num_rows > 0) {
          while($nombrec = $resultevaluacion->fetch_array(MYSQLI_ASSOC)) {
            ...
            $porcentaje_eva='0';
            $suma2 = "SELECT e.id_evaluacion, e.fecha_evaluacion, e.id_item_estandar_fk, e.justificacion_evaluacion, e.archivo_evaluacion, e.id_creacion_fk, e.estado_evaluacion, sum(e.porcentaje_evaluacion) AS resultado_evaluacion, i.id_item_estandar, i.indice_item_estandar, i.pregunta_item_estandar, i.valor_item_estandar, i.id_ciclo_fk, i.id_categoria_estandar_fk, i.id_subcategoria_estandar_fk,
